...
namespace TasksManagement.Migrations
{
    ...
    partial class TasksManagementDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TasksManagement.Tasks.DailyTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TasksManagement.Tasks.UpdatedDailyTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UpdatedDailyTasks", (string)null);
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TasksManagement.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TasksManagement.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TasksManagement.Tasks.DailyTask", b =>
                {
                    b.HasOne("TasksManagement.Authorization.Users.User", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("TasksManagement.Tasks.UpdatedDailyTask", b =>
                {
                    b.HasOne("TasksManagement.Tasks.DailyTask", "DailyTask")
                        .WithMany()
