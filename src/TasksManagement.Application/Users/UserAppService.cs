...
using TasksManagement.Authorization.Accounts;
...
namespace TasksManagement.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
            ...
            : base(repository)
        {
            ...
            this.LocalizationSourceName = TasksManagementConsts.LocalizationSourceName;
        }
        ...
        public async Task<List<CustomUserDto>> GetEmployees()
        {
            var employeeRole = await _roleManager.FindByNameAsync("Employee");

            if (employeeRole != null)
            {
                var usersInRole = await _userManager.GetUsersInRoleAsync(employeeRole.Name);

                var customUsers = usersInRole.Select(u => new CustomUserDto
                {
                    Id = u.Id,
                    Name = u.FullName,
                }).ToList();
