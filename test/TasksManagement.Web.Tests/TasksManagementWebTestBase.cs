...
using TasksManagement.Models.TokenAuth;
...
{
    public abstract class TasksManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TasksManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TasksManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TasksManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TasksManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TasksManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TasksManagementDbContext, Task<T>> func)
        {
            T result;
